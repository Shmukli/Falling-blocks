...
void engine::Engine::initWindow() {
    ...
    //object::ITypeBlock block(this->scale);               //Test 1 for IType
    //object::LTypeBlock l_block(this->scale);             //Test 2 for LType
    //object::SQUARETypeBlock square_block(this->scale);   //Test 3 for SquareType
    //object::STypeBlock s_block(this->scale);             //Test 4 for SType
    //object::TTypeBlock t_block(this->scale);             //Test 5 for TType
...
void engine::Engine::moveToPreviousPosition(std::vector<object::GameBlock>& block, std::vector<sf::Vector2f>& previousPosition) {
...
//TODO generating of blocks for testing movement functions.
